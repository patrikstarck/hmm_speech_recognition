...
//Init data
uint8_t number_of_sequences[NUMBER_OF_WORDS] = {29,11,11};
uint8_t word_sequence_length[NUMBER_OF_WORDS][MAX_SEQ_PER_WORD]={
  {4,5,5,6,6,4,5,5,4,6,4,5,6,6,6,5,6,5,4,5,5,6,6,4,5,4,6,6,6},
