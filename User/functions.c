...
//Init data
uint8_t number_of_sequences[NUMBER_OF_WORDS] = {12,11,9};
uint8_t word_sequence_length[NUMBER_OF_WORDS][MAX_SEQ_PER_WORD]={
  {4,5,6,6,7,6,5,6,7,8,5,4},
...
uint8_t word_sequences[NUMBER_OF_WORDS][MAX_SEQ_PER_WORD][MAX_SEQUENCES_PER_SEQ] = {
    /*Lampa*/
    {{0,4,1,3},{1,2,4,1,4},{1,2,4,1,3,4},{0,2,4,1,3,4},{1,2,3,4,1,3,4},{0,2,4,1,3,4},{1,2,4,1,4},{0,1,2,3,4,1},{1,2,4,3,1,3,4},{0,1,2,4,3,1,3,4},{0,1,2,4,1},{1,2,4,1}},
    /*Tänd*/
    {{5,6,0,7,8},{5,6,0,7,0},{5,6,0,7},{6,7,0},{5,6,0,6,7},{5,6,1,7},{5,6,1,7,8},{5,6,7,8},{5,6,7},{5,6,3,7,8},{5,6,0,8}},
    /*Släck*/
    {{9,0,6,4,10},{9,5,7,0,6,4,10},{9,7,6,4,10},{9,0,6,2,4,10},{9,10,0,6,4,10},{9,0,6,5,10},{0,6,4,10},{8,6,4,10},{8,6,5,4,10}}
 };
