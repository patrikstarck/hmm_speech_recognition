...
uint8_t word_sequence_length[NUMBER_OF_WORDS][MAX_SEQ_PER_WORD]={
  {4,5,6,6,7,6,5,6,7,8,5,4,5,5,6,6},
...
uint8_t word_sequences[NUMBER_OF_WORDS][MAX_SEQ_PER_WORD][MAX_SEQUENCES_PER_SEQ] = {
    /*Lampa*/
    {{0,4,1,3},{1,2,4,1,4},{1,2,4,1,3,4},{0,2,4,1,3,4},{1,2,3,4,1,3,4},{0,2,4,1,3,4},{1,2,4,1,4},{0,1,2,3,4,1},{1,2,4,3,1,3,4},{0,1,2,4,3,1,3,4},{0,1,2,4,1},{1,2,4,1},{0,1,7,8,1},{1,2,7,4,1},{1,2,7,2,4,1},{1,2,7,2,5,1}},
    /*Tänd*/
